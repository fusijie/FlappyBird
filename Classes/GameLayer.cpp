...
void GameLayer::birdSpriteFadeOut(){
    bird->getPhysicsBody()->setVelocity(Point(0.0f, 0.0f));
    ...
    this->scheduleOnce(schedule_selector(GameLayer::birdSpriteRemove),1.0f);
}

void GameLayer::birdSpriteRemove(float dt){
